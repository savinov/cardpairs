...
import com.github.savinov.cardpairs.ui.swing.CardTablePanel;

class CardTablePanelTest {
	public static void main(String[] args) {
		System.out.println("Card table panel testing ...");
		...
		for (BoardSize size : BoardSize.values()) {
			...
			CardTablePanel panel = new CardTablePanel(table, null);
